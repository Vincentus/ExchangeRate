...
import com.example.currencyexchange.ListItemClass;
...
public class CustomArrayAdapter extends ArrayAdapter<ListItemClass> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            viewHolder.data1 = convertView.findViewById(R.id.data1);
            viewHolder.data2 = convertView.findViewById(R.id.data2);
            viewHolder.data3 = convertView.findViewById(R.id.data3);
